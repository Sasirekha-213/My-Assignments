...
public class LinkLeafGround {
	public static void main(String[] args) throws InterruptedException {	
		  ...
		  List<WebElement> Count=driver.findElements(By.xpath("//a[text()='How many links in this page?']"));
		  System.out.println("Count of links in this page:"+ Count.size());
		  
		  List<WebElement> Layout=driver.findElements(By.xpath("//a[text()='How many links in this layout?']"));
		  System.out.println("Count of links in this layout:"+ Layout.size());
