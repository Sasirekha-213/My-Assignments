...
public class WebElementVerification {
	...
	//get text & get tag name (As per notes)		
	...
	//get Location & Size (As per notes)	
	...
	//Boolean type-is Selected (As per notes)
