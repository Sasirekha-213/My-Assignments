...
public class InputLeafGround {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Type your name
		driver.findElement(By.id("j_idt88:name")).sendKeys("Sasirekha");
		...
		WebElement Check=driver.findElement(By.name("j_idt88:j_idt93"));
		...
		Tab.sendKeys("sample@gmail.com");
		Tab.sendKeys(Keys.TAB);

		//Type about yourself
		driver.findElement(By.xpath("//textarea[@id='j_idt88:j_idt101']")).sendKeys("I am an Ambitious Person");

		//Just Press Enter and confirm error message*
		WebElement Text=driver.findElement(By.name("j_idt106:thisform:age"));
		...
		driver.findElement(By.xpath("(//input[contains(@id,'j_idt106')])[3]")).sendKeys("Saileela");
		WebElement Name=driver.findElement(By.xpath("(//li[contains(@data-item-value,'Saileela')])[4]"));
		Name.click();

		//Type your DOB (mm/dd/yyyy) and confirm date chosen
		driver.findElement(By.xpath("(//input[contains(@id,'j_idt106')])[4]")).sendKeys("21/3/2000");
        ...
        driver.findElement(By.xpath("(//input[contains(@id,'j_idt106')])[6]")).sendKeys("37");
